    ...
    <main className="min-h-screen grid-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs text-ash tracking-[0.2em] uppercase mb-2">
              Identifiant
            </label>
            <input
              type="text"
          ...
          {error && (
            <div className="text-crit text-xs tracking-wider py-2 border border-crit border-opacity-30 px-3">
              {error}
            </div>
          )}
